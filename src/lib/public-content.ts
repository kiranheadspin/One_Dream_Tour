export const publicPages = {
  tournament: {
    ...
    sections: [
      { title: "Tournament format", body: "Seven-over matches in a league format. Every entered team is guaranteed at least two matches. Two teams from each host city progress to the quarter-finals in Goa." },
      ...
      { title: "Season window", body: "City leagues are planned between September and December 2026. Exact dates, venues and registration deadlines will be published only after confirmation." },
    ],
  },
  "road-to-goa": {
    ...
    sections: [
      { title: "1. City league", body: "Corporate teams compete in a seven-over league with at least two matches guaranteed for every entered team." },
      { title: "2. City qualification", body: "The top two teams from each host city earn their place in the eight-team Goa quarter-finals." },
  ...
  rules: {
    ...
    sections: [
      { title: "Known format", body: "Corporate teams only; tennis-ball cricket; seven overs per match; league-stage play; at least two matches per entered team; two qualifiers per host city." },
